...
public class HospitalInfoActivity extends AppCompatActivity {
    ...
    public void saveHospitalInfo(){
        ...
        if(contactNo.isEmpty()){
            Toast.makeText(this, "Please Enter Your contactNo.", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(firebaseAuth.getCurrentUser().isEmailVerified()) {
            startActivity(new Intent(HospitalInfoActivity.this, HospitalPage.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP));
            finish();
        }else {
